...
from raisim_gym.env.env.laikago import __LAIKAGO_RESOURCE_DIRECTORY__ as __RSCDIR__
...
saver = ConfigurationSaver(log_dir=log_dir+'/Laikago_blind_locomotion',
                           save_items=[rsg_root+'raisim_gym/env/env/laikago/Environment.hpp', cfg_abs_path])
