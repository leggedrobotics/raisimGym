...
class LstmPolicy(ActorCriticPolicy):
    ...
    :param net_arch: (list) Specification of the actor-critic policy network archi. Notation similar to the
...
class FeedForwardPolicy(ActorCriticPolicy):
    ...
    :param net_arch: (list) Specification of the actor-critic policy network archi (see mlp_extractor
...
class MlpPolicy(FeedForwardPolicy):
    ...
    def __init__(self, sess, ob_space, ac_space, n_env, n_steps, n_batch, net_arch=None, reuse=False, **_kwargs):
        super(MlpPolicy, self).__init__(sess=sess, ob_space=ob_space, ac_space=ac_space, n_env=n_env, n_steps=n_steps,
                                        n_batch=n_batch, reuse=reuse, net_arch=net_arch, feature_extraction="mlp",
                                        **_kwargs)
